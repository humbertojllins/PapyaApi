...
namespace papya_api.Controllers
{
    ...
    public class LoginFuncionarioController : Controller
    {
        ...
        public object Post(
            ...
            [FromServices] DataProvider.FuncionarioDAO funcDAO,
            ...
            [FromServices]TokenConfigurations tokenConfigurations)
        {
            ...
            try
            {
                ...
                IEnumerable<Funcionario> lista =null;
                if (usuario != null && !String.IsNullOrWhiteSpace(usuario.Telefone))
                {
                    ...
                    {
                        lista = funcDAO.Find(usuarioBase.Id);
                    }
                }

                ICollection<Funcionario> lc = lista as ICollection<Funcionario>;

                if (credenciaisValidas==true && (lc !=null && lc.Count>0))
                {
